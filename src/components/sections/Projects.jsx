      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col justify-between p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)]">
              ...
              <p className="text-gray-400 mb-4">
                AI Resume Analyzer is a full-stack MERN application that
                evaluates resumes against job descriptions using AI. Users can
                upload PDF resumes and receive an ATS score, missing keywords,
                and personalized suggestions. Integrated Cohere AI for
                intelligent analysis, Firebase for Google authentication, and
        ...
        hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
              ...
              <div className="flex flex-col gap-2 mt-4">
                ...
                <a
                  href="https://github.com/SaisasankGunji/AI-resume-analyzer"
                  className="text-blue-400 hover:text-blue-300 transition-colors"
                >
                  GitHub Repository
                  <span className="mx-2 font-extrabold">&#8594;</span>
